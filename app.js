...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'data', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 6215962, "filename": "/multimedia.pak"}, {"start": 6215962, "audio": 0, "end": 6216986, "filename": "/data/data"}, {"start": 6216986, "audio": 0, "end": 6218010, "filename": "/data/data.bkp"}], "remote_package_size": 6218010, "package_uuid": "39bd648d-b6d6-4f2c-b9a8-fbeac486cb30"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 1705600,
    DYNAMIC_BASE = 6948480,
    DYNAMICTOP_PTR = 1704672;
...
var ASM_CONSTS = {
  452378: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 ...
 490899: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 491888: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 491981: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 493206: function() {return screen.width;},  
 493233: function() {return screen.height;},  
 493261: function() {return window.innerWidth;},  
 493293: function() {return window.innerHeight;},  
 493371: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 493505: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 493671: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=1705584;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 1704832;
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 1704736, 4), 1704736);function _gmtime_r(time, tmPtr) {
